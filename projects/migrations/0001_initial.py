        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        blank=True,
                        help_text="Client-provided documents (PDF, DOC, DOCX)",
                        null=True,
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Type of project package",
                        max_length=50,
                        unique=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Base price for the package",
                        max_digits=10,
                        validators=[
                ...
                (
                    "features",
                    models.JSONField(
                        default=dict, help_text="Package features in JSON format"
                    ),
                ),
                (
                    "tech_stack",
                    models.JSONField(
                        default=list, help_text="Technologies used in this package"
                    ),
                ),
                (
                    "deliverables",
                    models.JSONField(default=list, help_text="Project deliverables"),
                ),
                (
                    "estimated_duration",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=30,
                        help_text="Support period in days",
                        validators=[django.core.validators.MinValueValidator(1)],
                    ),
                ),
                (
                    ...
                    models.PositiveIntegerField(
                        default=24,
                        help_text="Response time in hours",
                        validators=[django.core.validators.MinValueValidator(1)],
                    ),
                ),
            ],
