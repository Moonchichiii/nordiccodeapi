            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        max_length=150,
                        validators=[
                            django.core.validators.RegexValidator("^[a-zA-Z\\s]{2,}$")
                        ],
                ...
                (
                    "accepted_terms",
                    models.BooleanField(
                        db_index=True, default=False, verbose_name="accepted terms"
                    ),
                ),
                (
                    "marketing_consent",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="users_custo_email_e94323_idx",
                    ),
                    models.Index(
                        fields=["is_staff", "is_active"],
                        name="users_custo_is_staf_2f15ad_idx",
                    ),
                ],
            },
        ),
